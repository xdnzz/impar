...
export function Card({name, image, id, handleDeleteCard, callUnderConstructionFunction}: ICards) {
    return (
        <div className="p-6" key={id}>
            ...
            <div className="flex text-slate-500  items-center w-full justify-center border rounded-b-md">
                ...
                <button className="flex items-center p-3 hover:text-red-700" onClick={callUnderConstructionFunction}> <img src={edit} className="pr-2 "/>Editar</button>
            </div>
